...
<a href="https://travis-ci.org/azagramac/timeoff"><img align="right" src="https://travis-ci.org/azagramac/timeoff.svg?branch=master" alt="Build status" /></a>
...
![TimeOff.Management Screenshot](https://raw.githubusercontent.com/azagramac/timeoff/master/public/img/readme_screenshot.png)
...
```bash
git clone https://github.com//azagramac/timeoff.git
cd timeoff
npm install
npm start
```
